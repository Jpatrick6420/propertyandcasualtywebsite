...
function ClaimsSection({ handleCurrentData }) {
  ...
  const handleSubmit = (e) => {
    ...
    handleCurrentData((prev) => ({
      ...
      auto: {
        ...
        claims: [
          ...prev.auto.claims,
          { type: currentClaim.type, date: currentClaim.date },
        ],
      },
    }));
  ...
  return (
    <>
      ...
      <section className="bg-red-200 px-2 py-0.5">
        <div className="grid grid-cols-6 mb-2">
          <label className="mr-2">Enter Claim Type</label>
          <input
            className="border-2 border-gray-600 col-span-2"
            type="text"
